![enter image description here](https://github.com/gitjosephio/Anomaly-detection/blob/main/uos_logo.png?raw=true)

# **Diabetes Prediction Dashboard Documentation**

![enter image description here](https://github.com/gitjosephio/Diabetes-detection-project/blob/main/diabetes44.png?raw=true)
***IBOURK Youssef***

## **INTRODUCTION :**

Welcome to our diabetes dashboard! Our dashboard is designed to provide you with insights into the diabetes dataset. Diabetes is a chronic disease that affects millions of people worldwide, and our dashboard aims to help you better understand this disease.
So this dashboard allows you to upload a CSV or XLSX file, perform data cleaning, and analyze the data to understand relationships between the variables, patterns in the data, and build predictive models.
The data for our dashboard comes from the National Institute of Diabetes and Digestive and Kidney Diseases. We performed data cleaning, and analyze the data to understand relationships between the variables, patterns in the data, and build predictive models.
...
RStudio was selected as the primary IDE for this project due to its ease of use and comprehensive features. It provides an interactive console for executing code, project management capabilities, and efficient data analysis tools. The code is developed and executed within the RStudio environment, ensuring a seamless workflow.

## **Upload Data:**

The first step is to upload your data file in either CSV or XLSX format. You can use the "Browse" button to select the file from your local computer.
...
We are constantly working to improve our dashboard and provide users with better insights into the diabetes dataset. Some future directions for our dashboard include:
...
Our dashboard provides valuable insights into the diabetes dataset and can help users better understand this chronic disease. We hope that our dashboard is useful for you and that you find it informative and easy to use. Thank you for using our dashboard!